...
2. Crea una rama: `git checkout -b feature/772-add-content`
3. Agrega tu contenido en la carpeta correspondiente
4. Commit: `git commit -m "feat(772): agregar [descripción]"`
5. Push y crea un Pull Request

**Formato de commits:**
- `feat(772): ` para nuevo contenido
- `fix(772): ` para correcciones
- `docs(772): ` para documentación
...
**Ruta:** [Área de Software](../../) → [2024 - Segundo Semestre](../) → [772] Estructura de Datos
