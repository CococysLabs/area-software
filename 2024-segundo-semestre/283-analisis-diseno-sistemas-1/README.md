# [283] Análisis y Diseño de Sistemas 1
...
2. Crea una rama: `git checkout -b feature/283-add-content`
3. Agrega tu contenido en la carpeta correspondiente
4. Commit: `git commit -m "feat(283): agregar [descripción]"`
5. Push y crea un Pull Request

**Formato de commits:**
- `feat(283): ` para nuevo contenido
- `fix(283): ` para correcciones
- `docs(283): ` para documentación
...
**Ruta:** [Área de Software](../../) → [2024 - Segundo Semestre](../) → [283] Análisis y Diseño de Sistemas 1
